...
# Load the dataset
df = pd.read_csv(r"E:\Machine Learning(python)\GTZAN dataset\features_30_sec.csv")
...
le = LabelEncoder()
y = le.fit_transform(class_column)
...
perceptron_cv = RandomizedSearchCV(perceptron, perceptron_grid, cv=5, scoring='accuracy', n_iter=10)
mlp_cv = RandomizedSearchCV(mlp, mlp_grid, cv=5, scoring='accuracy', n_iter=10)
